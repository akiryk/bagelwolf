...
- **Short story:** 1-2 paragraphs about the bakery
- **Featured products:** 3-4 best-selling bagels as cards
- **Secondary CTAs:** Links to Bagels and Bread pages
...
- **Process/craft:**
  ...
  - 24-hour cold ferment to optimize flavor and crust
  - Extensive experimentation to find the perfect flavor and chewiness
- **Values:** Quality, craft, local, small-batch
- **Photos:** Placeholder for bakery/process photos
...
- **Bagel types (v1):**
  ...
  |------|------|-------------|
  | plain | Plain | Classic sourdough bagel |
  | sesame | Sesame | Topped with toasted sesame seeds |
  | everything | Everything | Sesame, poppy, garlic, onion, and salt |
  | onion | Onion | Topped with dried onion flakes |
  | garlic | Garlic | Topped with roasted garlic bits |
  | pumpernickel | Pumpernickel | Dark rye with cocoa and molasses |
...
- **Bread types (v1):**
  | Slug | Name | Description |
  |------|------|-------------|
  | country-sourdough | Country Sourdough | Classic open-crumb sourdough boule |
  | olive-rosemary | Olive Rosemary | Sourdough studded with olives and fresh rosemary |
  | danish-rugbrod | Danish Rugbrød | Dense, seeded Danish rye bread |

- **Baking schedule:**
  - **Thursday:** Rye breads
  - **Friday:** Boules (Country Sourdough, Olive Rosemary)
  - **Saturday:** Bagels
...
- Newsletter signup: Name + email form (non-functional placeholder for now)
- Copy: "Get bake schedules and new bagel flavors by email"
